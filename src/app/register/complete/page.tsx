  ...
  return (
    <main className="relative flex min-h-dvh items-center justify-center overflow-hidden px-6">
      ...
      <div className="glass-card relative z-10 flex w-full max-w-md flex-col items-center p-9 text-center animate-pop-in">
        <div className="flex h-20 w-20 items-center justify-center rounded-full bg-brand-gradient shadow-card">
        ...
        <h1 className="mt-6 text-xl font-extrabold text-navy-800">등록이 완료되었습니다.</h1>
